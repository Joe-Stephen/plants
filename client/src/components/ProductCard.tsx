    ...
    <div className="bg-white rounded-2xl shadow-sm border border-gray-100 overflow-hidden hover:shadow-xl hover:-translate-y-1 transition-all duration-300 group relative">
      ...
      <div className="p-5">
        ...
        <div className="flex items-center justify-between mt-4">
          ...
          <button 
            className="w-10 h-10 flex items-center justify-center bg-gray-100 rounded-lg text-gray-700 hover:bg-primary-600 hover:text-white transition-all transform active:scale-95"
            title="Add to Cart"
          >
