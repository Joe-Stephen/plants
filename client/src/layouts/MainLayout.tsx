...
const MainLayout = () => {
  ...
  const cartItemCount =
    cartData?.cart?.items.reduce((acc, item) => acc + item.quantity, 0) || 0;
  ...
  return (
    <div className="min-h-screen flex flex-col bg-gray-50 font-sans">
      ...
      >
        <div className="container mx-auto px-6">
          <div className="flex justify-between items-center">
            ...
            <Link to="/" className="flex items-center space-x-2 group">
              ...
              <span
                className={`text-2xl font-bold tracking-tight ${scrolled ? 'text-gray-900' : 'text-gray-900 md:text-gray-800'}`}
              >
              ...
              <div className="flex items-center space-x-4 border-l pl-8 border-gray-200">
                ...
                {user ? (
                  ...
                  <div className="flex items-center space-x-3">
                    ...
                    <Link
                      to="/signup"
                      className="bg-primary-600 text-white px-4 py-2 rounded-lg hover:bg-primary-700 font-medium transition-colors shadow-lg shadow-primary-600/20"
                    >
                      Sign Up
                    </Link>
                  </div>
        ...
        {isMenuOpen && (
          <div className="md:hidden absolute top-full left-0 w-full bg-white border-t border-gray-100 shadow-xl p-6 flex flex-col space-y-4 animate-in slide-in-from-top-5">
            ...
            <Link to="/shop" className="text-lg font-medium text-gray-800">
              Shop
            </Link>
            <Link
              to="/cart"
            ...
            <div className="border-t pt-4">
              {user ? (
                <>
                  ...
                  <button
                    onClick={handleLogout}
                    className="text-red-500 mt-2 flex items-center font-medium"
                  >
                ...
                <div className="grid grid-cols-2 gap-4">
                  <Link
                    to="/login"
                    className="text-center py-2 border rounded-lg hover:bg-gray-50"
                  >
                    Login
                  </Link>
                  <Link
                    to="/signup"
                    className="text-center py-2 bg-primary-600 text-white rounded-lg hover:bg-primary-700"
                  >
                    Sign Up
                  </Link>
                </div>
      ...
      <main className="flex-grow pt-24 md:pt-28">
        ...
        <div
          className={
            location.pathname === '/' ? '' : 'container mx-auto px-6 py-6'
          }
        >
          <Outlet />
        </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-12 mb-12">
            <div>
              ...
              <p className="text-gray-400 leading-relaxed">
                Bringing the beauty of nature into your modern living space with
                our curated plant collection.
              </p>
            </div>
